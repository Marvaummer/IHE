...
class Apioutservice {
  ...
  // Function to fetch the vehicle out of service list
  Future<List<OutOfServiceModel>> fetchVehicleOutOfServiceList() async {
    final url = Uri.parse("$_baseUrl/GetVehicleOutofServiceList?userId=1");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return outOfServiceModelFromJson(response.body);
      } else {
  ...
  // Function to fetch the vehicle at garage list
